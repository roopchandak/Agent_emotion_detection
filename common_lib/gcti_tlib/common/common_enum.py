...
CfgSolutionType = Enum("""
  CFGSTNoSolutionType           = 0,
  CFGSTDefaultSolutionType      = 1,
  CFGSTIntegratedScreenPop      = 2,
  CFGSTEnterpriseRouting        = 3,
  CFGSTNetworkRouting           = 4,
  CFGSTOutboundDialing          = 5,
  CFGSTWorkforceManagement      = 6,
  CFGSTVoiceSelfService         = 7,
  CFGSTInternetContactCenter    = 8,
  CFGSTWorkflowRouting          = 9,
  CFGSTInformationAnalysis      = 10,
  CFGSTKnowledgeWorker          = 11,
  CFGSTBranchOffice             = 12,
  CFGSTFramework                = 13,
  CFGSTExpressEdition           = 14,
  CFGSTMultiChannelRouting      = 15,
  CFGSTDesktopNETServerSolution = 16,
